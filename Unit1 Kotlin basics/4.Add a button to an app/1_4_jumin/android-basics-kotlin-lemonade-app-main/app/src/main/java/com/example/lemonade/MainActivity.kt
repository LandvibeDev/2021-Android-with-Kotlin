...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickLemonImage() {
        ...
        when(lemonadeState) {
            ...
            RESTART -> {
                // When the image is clicked in the RESTART state the state sholud become SELECT
    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                textName = R.string.lemon_select
                imageName = R.drawable.lemon_tree
            }
            SQUEEZE -> {
                textName = R.string.lemon_squeeze
                imageName = R.drawable.lemon_squeeze
            }
            DRINK -> {
                textName = R.string.lemon_drink
                imageName = R.drawable.lemon_drink
            }
            RESTART -> {
                textName = R.string.lemon_empty_glass
                imageName = R.drawable.lemon_restart
            }
        }

        textAction.setText(textName)
        lemonImage?.setImageResource(imageName)
